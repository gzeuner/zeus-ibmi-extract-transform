...
public final class RunManifestJsonSerializer {
  ...
  public static String toJson(RunManifest manifest) {
    ...
    return "{"
        + "\"toolName\":\""
        + escape(manifest.toolName())
        + "\","
        + "\"toolVersion\":\""
        + escape(manifest.toolVersion())
        + "\","
        + "\"runId\":\""
        + escape(manifest.runId())
        + "\","
        + "\"status\":\""
        ...
        + ","
        + "\"startedAt\":\""
        + toStringOrEmpty(manifest.startedAt())
        + "\","
        + "\"finishedAt\":\""
        + toStringOrEmpty(manifest.finishedAt())
        + "\","
        + "\"durationMillis\":"
        + manifest.durationMillis()
        + ","
        + "\"configSource\":\""
        + escape(manifest.configSource())
        + "\","
        + "\"querySourceType\":\""
        + escape(manifest.querySourceType())
        + "\","
        + "\"querySource\":\""
        + escape(manifest.querySource())
        + "\","
        + "\"queryHash\":\""
        + escape(manifest.queryHash())
        + "\","
        + "\"queryPreview\":\""
        + escape(manifest.queryPreview())
        + "\","
        + "\"outputDirectory\":\""
        + escape(manifest.outputDirectory())
        + "\","
        + "\"outputFiles\":"
        + outputs
        + ","
        ...
        + ","
        + "\"errorClass\":\""
        + escape(manifest.errorClass())
        + "\","
        + "\"errorMessage\":\""
        + escape(manifest.errorMessage())
        + "\","
        + "\"javaVersion\":\""
        + escape(manifest.javaVersion())
        + "\","
        + "\"osName\":\""
        + escape(manifest.osName())
        + "\","
        + "\"osVersion\":\""
        + escape(manifest.osVersion())
        + "\""
        + "}";
  }
    ...
    for (OutputFileMetadata file : files) {
      joiner.add(
          "{"
              ...
              + "\","
              + "\"writtenAt\":\""
              + toStringOrEmpty(file.writtenAt())
              + "\""
              + "}");
    }
    return joiner;
