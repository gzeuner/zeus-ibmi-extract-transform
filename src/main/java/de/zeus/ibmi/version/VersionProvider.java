...
public final class VersionProvider {
    ...
    public static final String DEVELOPMENT_FALLBACK_VERSION = "0.1.0-SNAPSHOT";
    ...
    public VersionProvider() {
        this(
                () -> readNormalized(VersionProvider.class.getPackage() == null
                        ? null
    ...
    public VersionProvider(
        ...
        this.fallbackVersion = readNormalized(fallbackVersion) == null
                ? DEVELOPMENT_FALLBACK_VERSION
