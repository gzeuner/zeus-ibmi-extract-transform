...
class ExitCodeMapperTest {
    ...
    void mapErrorClassName_shouldReturnExpectedCodes() {
        assertEquals(ExitCode.CONFIG_ERROR, ExitCodeMapper.mapErrorClassName(ConfigValidationException.class.getName()));
        assertEquals(ExitCode.QUERY_GUARD_ERROR, ExitCodeMapper.mapErrorClassName(QueryGuardException.class.getName()));
        assertEquals(ExitCode.JDBC_ERROR, ExitCodeMapper.mapErrorClassName(QueryExecutionException.class.getName()));
        assertEquals(ExitCode.OUTPUT_ERROR, ExitCodeMapper.mapErrorClassName(OutputWriteException.class.getName()));
        assertEquals(ExitCode.MANIFEST_ERROR, ExitCodeMapper.mapErrorClassName(ManifestException.class.getName()));
        assertEquals(ExitCode.GENERAL_ERROR, ExitCodeMapper.mapErrorClassName(IllegalStateException.class.getName()));
